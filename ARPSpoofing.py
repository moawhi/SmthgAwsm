...
def _enable_macos_iproute():
    """
    Enables IP route (IP Forwarding) in macOS
    """
...
def enable_ip_route(verbose=True):
    """
    Enables IP forwarding based on the operating system
    """
    if verbose:
    ...
    if "nt" in os.name:
        ...
        print("[-] Unsupported operating system. IP forwarding not enabled.")
